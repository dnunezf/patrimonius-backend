...
ALTER TABLE Comentario
  ADD COLUMN fecha DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER descripcion,
  ADD COLUMN resuelto TINYINT(1) NOT NULL DEFAULT 0 AFTER fecha;
...
-- indexes and constraints for robust metadata usage
